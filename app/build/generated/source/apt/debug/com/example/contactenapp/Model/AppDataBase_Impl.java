  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `contacts` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT, `email` TEXT, `phoneNumber` TEXT, `profilePictureUri` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1e76627eec0be3cdc535e7e5089f4fae')");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsContacts.put("phoneNumber", new TableInfo.Column("phoneNumber", "TEXT", false, 0));
        _columnsContacts.put("profilePictureUri", new TableInfo.Column("profilePictureUri", "TEXT", false, 0));
        ...
        if (! _infoContacts.equals(_existingContacts)) {
          throw new IllegalStateException("Migration didn't properly handle contacts(com.example.contactenapp.Model.Contact).\n"
                  + " Expected:\n" + _infoContacts + "\n"
                  + " Found:\n" + _existingContacts);
        }
      }
    }, "1e76627eec0be3cdc535e7e5089f4fae", "e5cbf94f5e4d5932158f28af35a374b9");
